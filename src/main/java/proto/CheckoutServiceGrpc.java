...
public final class CheckoutServiceGrpc {
  ...
  public static final String SERVICE_NAME = "CheckoutService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<proto.Demo.PlaceOrderRequest,
      proto.Demo.PlaceOrderResponse> getPlaceOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlaceOrder",
      requestType = proto.Demo.PlaceOrderRequest.class,
      responseType = proto.Demo.PlaceOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.PlaceOrderRequest,
      proto.Demo.PlaceOrderResponse> getPlaceOrderMethod() {
    io.grpc.MethodDescriptor<proto.Demo.PlaceOrderRequest, proto.Demo.PlaceOrderResponse> getPlaceOrderMethod;
      ...
      synchronized (CheckoutServiceGrpc.class) {
        if ((getPlaceOrderMethod = CheckoutServiceGrpc.getPlaceOrderMethod) == null) {
          CheckoutServiceGrpc.getPlaceOrderMethod = getPlaceOrderMethod =
              io.grpc.MethodDescriptor.<proto.Demo.PlaceOrderRequest, proto.Demo.PlaceOrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlaceOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.PlaceOrderRequest.getDefaultInstance()))
  ...
  public static abstract class CheckoutServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void placeOrder(proto.Demo.PlaceOrderRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.PlaceOrderResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Demo.PlaceOrderRequest,
                proto.Demo.PlaceOrderResponse>(
  ...
  /**
   */
  public static final class CheckoutServiceStub extends io.grpc.stub.AbstractAsyncStub<CheckoutServiceStub> {
  ...
  /**
   */
  public static final class CheckoutServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CheckoutServiceBlockingStub> {
    ...
    /**
     */
    public proto.Demo.PlaceOrderResponse placeOrder(proto.Demo.PlaceOrderRequest request) {
  ...
  /**
   */
  public static final class CheckoutServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CheckoutServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.PlaceOrderResponse> placeOrder(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLACE_ORDER:
          serviceImpl.placeOrder((proto.Demo.PlaceOrderRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.PlaceOrderResponse>) responseObserver);
          break;
        default:

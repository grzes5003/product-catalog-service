...
public final class CartServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.AddItemRequest,
      proto.Demo.Empty> getAddItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddItem",
      requestType = proto.Demo.AddItemRequest.class,
      responseType = proto.Demo.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.AddItemRequest,
      proto.Demo.Empty> getAddItemMethod() {
    io.grpc.MethodDescriptor<proto.Demo.AddItemRequest, proto.Demo.Empty> getAddItemMethod;
      ...
      synchronized (CartServiceGrpc.class) {
        if ((getAddItemMethod = CartServiceGrpc.getAddItemMethod) == null) {
          CartServiceGrpc.getAddItemMethod = getAddItemMethod =
              io.grpc.MethodDescriptor.<proto.Demo.AddItemRequest, proto.Demo.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.AddItemRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.GetCartRequest,
      proto.Demo.Cart> getGetCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCart",
      requestType = proto.Demo.GetCartRequest.class,
      responseType = proto.Demo.Cart.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.GetCartRequest,
      proto.Demo.Cart> getGetCartMethod() {
    io.grpc.MethodDescriptor<proto.Demo.GetCartRequest, proto.Demo.Cart> getGetCartMethod;
    if ((getGetCartMethod = CartServiceGrpc.getGetCartMethod) == null) {
      synchronized (CartServiceGrpc.class) {
        if ((getGetCartMethod = CartServiceGrpc.getGetCartMethod) == null) {
          CartServiceGrpc.getGetCartMethod = getGetCartMethod =
              io.grpc.MethodDescriptor.<proto.Demo.GetCartRequest, proto.Demo.Cart>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.GetCartRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.EmptyCartRequest,
      proto.Demo.Empty> getEmptyCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EmptyCart",
      requestType = proto.Demo.EmptyCartRequest.class,
      responseType = proto.Demo.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.EmptyCartRequest,
      proto.Demo.Empty> getEmptyCartMethod() {
    io.grpc.MethodDescriptor<proto.Demo.EmptyCartRequest, proto.Demo.Empty> getEmptyCartMethod;
    if ((getEmptyCartMethod = CartServiceGrpc.getEmptyCartMethod) == null) {
      synchronized (CartServiceGrpc.class) {
        if ((getEmptyCartMethod = CartServiceGrpc.getEmptyCartMethod) == null) {
          CartServiceGrpc.getEmptyCartMethod = getEmptyCartMethod =
              io.grpc.MethodDescriptor.<proto.Demo.EmptyCartRequest, proto.Demo.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "EmptyCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.EmptyCartRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.Empty.getDefaultInstance()))
  ...
  public static abstract class CartServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addItem(proto.Demo.AddItemRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.Empty> responseObserver) {
      asyncUnimplementedUnaryCall(getAddItemMethod(), responseObserver);
    }

    /**
     */
    public void getCart(proto.Demo.GetCartRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.Cart> responseObserver) {
      asyncUnimplementedUnaryCall(getGetCartMethod(), responseObserver);
    }

    /**
     */
    public void emptyCart(proto.Demo.EmptyCartRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.Empty> responseObserver) {
  ...
  public static final class CartServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CartServiceBlockingStub> {
    ...
    /**
     */
    public proto.Demo.Empty addItem(proto.Demo.AddItemRequest request) {
    ...
    /**
     */
    public proto.Demo.Cart getCart(proto.Demo.GetCartRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public proto.Demo.Empty emptyCart(proto.Demo.EmptyCartRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CartServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CartServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.Empty> addItem(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.Cart> getCart(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.Empty> emptyCart(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_ITEM:
          serviceImpl.addItem((proto.Demo.AddItemRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.Empty>) responseObserver);
          break;
        case METHODID_GET_CART:
          serviceImpl.getCart((proto.Demo.GetCartRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.Cart>) responseObserver);
          break;
        case METHODID_EMPTY_CART:
          serviceImpl.emptyCart((proto.Demo.EmptyCartRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.Empty>) responseObserver);
          break;
        default:

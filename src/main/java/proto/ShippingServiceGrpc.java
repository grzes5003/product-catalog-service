...
public final class ShippingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "ShippingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<proto.Demo.GetQuoteRequest,
      proto.Demo.GetQuoteResponse> getGetQuoteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetQuote",
      requestType = proto.Demo.GetQuoteRequest.class,
      responseType = proto.Demo.GetQuoteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.GetQuoteRequest,
      proto.Demo.GetQuoteResponse> getGetQuoteMethod() {
    io.grpc.MethodDescriptor<proto.Demo.GetQuoteRequest, proto.Demo.GetQuoteResponse> getGetQuoteMethod;
      ...
      synchronized (ShippingServiceGrpc.class) {
        if ((getGetQuoteMethod = ShippingServiceGrpc.getGetQuoteMethod) == null) {
          ShippingServiceGrpc.getGetQuoteMethod = getGetQuoteMethod =
              io.grpc.MethodDescriptor.<proto.Demo.GetQuoteRequest, proto.Demo.GetQuoteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetQuote"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.GetQuoteRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.ShipOrderRequest,
      proto.Demo.ShipOrderResponse> getShipOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ShipOrder",
      requestType = proto.Demo.ShipOrderRequest.class,
      responseType = proto.Demo.ShipOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.ShipOrderRequest,
      proto.Demo.ShipOrderResponse> getShipOrderMethod() {
    io.grpc.MethodDescriptor<proto.Demo.ShipOrderRequest, proto.Demo.ShipOrderResponse> getShipOrderMethod;
      ...
      synchronized (ShippingServiceGrpc.class) {
        if ((getShipOrderMethod = ShippingServiceGrpc.getShipOrderMethod) == null) {
          ShippingServiceGrpc.getShipOrderMethod = getShipOrderMethod =
              io.grpc.MethodDescriptor.<proto.Demo.ShipOrderRequest, proto.Demo.ShipOrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ShipOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.ShipOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class ShippingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getQuote(proto.Demo.GetQuoteRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.GetQuoteResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetQuoteMethod(), responseObserver);
    }

    /**
     */
    public void shipOrder(proto.Demo.ShipOrderRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.ShipOrderResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Demo.GetQuoteRequest,
                proto.Demo.GetQuoteResponse>(
                  this, METHODID_GET_QUOTE)))
          .addMethod(
            getShipOrderMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                proto.Demo.ShipOrderRequest,
                proto.Demo.ShipOrderResponse>(
  ...
  /**
   */
  public static final class ShippingServiceStub extends io.grpc.stub.AbstractAsyncStub<ShippingServiceStub> {
  ...
  /**
   */
  public static final class ShippingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ShippingServiceBlockingStub> {
    ...
    /**
     */
    public proto.Demo.GetQuoteResponse getQuote(proto.Demo.GetQuoteRequest request) {
    ...
    /**
     */
    public proto.Demo.ShipOrderResponse shipOrder(proto.Demo.ShipOrderRequest request) {
      return blockingUnaryCall(
  ...
  /**
   */
  public static final class ShippingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ShippingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.GetQuoteResponse> getQuote(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.ShipOrderResponse> shipOrder(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_QUOTE:
          serviceImpl.getQuote((proto.Demo.GetQuoteRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.GetQuoteResponse>) responseObserver);
          break;
        case METHODID_SHIP_ORDER:
          serviceImpl.shipOrder((proto.Demo.ShipOrderRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.ShipOrderResponse>) responseObserver);
          break;
        default:

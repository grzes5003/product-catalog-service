...
public final class EmailServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.SendOrderConfirmationRequest,
      proto.Demo.Empty> getSendOrderConfirmationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendOrderConfirmation",
      requestType = proto.Demo.SendOrderConfirmationRequest.class,
      responseType = proto.Demo.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.SendOrderConfirmationRequest,
      proto.Demo.Empty> getSendOrderConfirmationMethod() {
    io.grpc.MethodDescriptor<proto.Demo.SendOrderConfirmationRequest, proto.Demo.Empty> getSendOrderConfirmationMethod;
      ...
      synchronized (EmailServiceGrpc.class) {
        if ((getSendOrderConfirmationMethod = EmailServiceGrpc.getSendOrderConfirmationMethod) == null) {
          EmailServiceGrpc.getSendOrderConfirmationMethod = getSendOrderConfirmationMethod =
              io.grpc.MethodDescriptor.<proto.Demo.SendOrderConfirmationRequest, proto.Demo.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendOrderConfirmation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.SendOrderConfirmationRequest.getDefaultInstance()))
  ...
  public static abstract class EmailServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendOrderConfirmation(proto.Demo.SendOrderConfirmationRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Demo.SendOrderConfirmationRequest,
                proto.Demo.Empty>(
  ...
  public static final class EmailServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EmailServiceBlockingStub> {
    ...
    /**
     */
    public proto.Demo.Empty sendOrderConfirmation(proto.Demo.SendOrderConfirmationRequest request) {
  ...
  public static final class EmailServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EmailServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.Empty> sendOrderConfirmation(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_ORDER_CONFIRMATION:
          serviceImpl.sendOrderConfirmation((proto.Demo.SendOrderConfirmationRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.Empty>) responseObserver);
          break;
        default:

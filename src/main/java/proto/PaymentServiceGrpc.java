...
public final class PaymentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Demo.ChargeRequest,
      proto.Demo.ChargeResponse> getChargeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Charge",
      requestType = proto.Demo.ChargeRequest.class,
      responseType = proto.Demo.ChargeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Demo.ChargeRequest,
      proto.Demo.ChargeResponse> getChargeMethod() {
    io.grpc.MethodDescriptor<proto.Demo.ChargeRequest, proto.Demo.ChargeResponse> getChargeMethod;
      ...
      synchronized (PaymentServiceGrpc.class) {
        if ((getChargeMethod = PaymentServiceGrpc.getChargeMethod) == null) {
          PaymentServiceGrpc.getChargeMethod = getChargeMethod =
              io.grpc.MethodDescriptor.<proto.Demo.ChargeRequest, proto.Demo.ChargeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Charge"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Demo.ChargeRequest.getDefaultInstance()))
  ...
  public static abstract class PaymentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void charge(proto.Demo.ChargeRequest request,
        io.grpc.stub.StreamObserver<proto.Demo.ChargeResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Demo.ChargeRequest,
                proto.Demo.ChargeResponse>(
  ...
  public static final class PaymentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PaymentServiceBlockingStub> {
    ...
    /**
     */
    public proto.Demo.ChargeResponse charge(proto.Demo.ChargeRequest request) {
  ...
  public static final class PaymentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PaymentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Demo.ChargeResponse> charge(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHARGE:
          serviceImpl.charge((proto.Demo.ChargeRequest) request,
              (io.grpc.stub.StreamObserver<proto.Demo.ChargeResponse>) responseObserver);
          break;
        default:
